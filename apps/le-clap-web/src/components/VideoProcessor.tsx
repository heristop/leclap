  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        className={clsx(
          'group flex items-center space-x-3 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]',
          'focus:outline-none focus:ring-4 focus:ring-brand-500/30',
          canProcess && !actuallyProcessing
            ? 'brand-gradient text-white hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 shadow-lg shadow-brand-900/30 hover:shadow-brand-500/40 cursor-pointer'
            : 'bg-gray-800 text-gray-500 cursor-not-allowed border border-white/5',
          actuallyProcessing && 'brand-gradient text-white cursor-wait opacity-95',
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            ...
            <div>
              ...
              <span className="ml-1 font-medium text-indigo-300">{template.descriptor.sections?.length ?? 0}</span>
            </div>
            <div>
