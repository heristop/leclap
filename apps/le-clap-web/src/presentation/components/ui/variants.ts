...
const BADGE_BASE = 'inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider'
...
export function cardVariants(opts: { elevation?: CardElevation; interactive?: boolean; gradientBorder?: boolean } = {}): string {
