...
export const EmptyState = ({ icon: Icon, title, hint, action }: EmptyStateProps) => (
  <div className="fade-in flex flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-foreground/15 bg-surface/30 px-6 py-14 text-center">
