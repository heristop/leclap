    ...
    <div className="flex items-center gap-1.5">
      ...
      <div className="relative flex-1">
        <input
          ...
          className="w-full rounded-lg border border-foreground/10 bg-surface-2 py-1.5 pl-2 pr-6 text-sm text-foreground transition-all focus-visible:border-brand-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/30"
        />
