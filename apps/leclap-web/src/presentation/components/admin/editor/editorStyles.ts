...
export const EDITOR_INPUT_CLASS =
  'w-full px-3 py-2 rounded-lg bg-surface-inset border border-foreground/15 text-foreground placeholder:text-gray-500 transition-colors hover:border-foreground/25 focus:outline-none focus:border-brand-500 focus:ring-2 focus:ring-brand-500/40';
