...
export const PartialsPage = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden bg-background bg-dots text-foreground">
      <Seo title="Partials" path="/partials" noindex />
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 pt-24 pb-16">
        ...
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
          <div>
            <h1 className="mb-1 text-4xl font-bold font-display text-foreground">Partials</h1>
            <p className="max-w-2xl text-gray-600 dark:text-gray-300">
              Build reusable scene fragments with the same visual controls as templates.
            </p>
          </div>
        </div>
