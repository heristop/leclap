...
#if canImport(leclap_ffmpeg_coreFFI)
import leclap_ffmpeg_coreFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_leclap_ffmpeg_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_leclap_ffmpeg_core_rustbuffer_free(self, $0) }
    }
}
...
extension ProbeResult: Equatable, Hashable {
...
public struct RunResult {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(code: Int32, log: String) {
        self.code = code
        self.log = log
    }
}
...
extension RunResult: Equatable, Hashable {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeRunResult: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RunResult {
        return
            try RunResult(
                code: FfiConverterInt32.read(from: &buf), 
    ...
    public static func write(_ value: RunResult, into buf: inout [UInt8]) {
        FfiConverterInt32.write(value.code, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRunResult_lift(_ buf: RustBuffer) throws -> RunResult {
    return try FfiConverterTypeRunResult.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRunResult_lower(_ value: RunResult) -> RustBuffer {
    return FfiConverterTypeRunResult.lower(value)
}
 ...
 */
public func cancel() {try! rustCall() {
    uniffi_leclap_ffmpeg_core_fn_func_cancel($0
    )
}
}
/**
 ...
 */
public func probe(args: [String]) -> ProbeResult {
    return try!  FfiConverterTypeProbeResult.lift(try! rustCall() {
    uniffi_leclap_ffmpeg_core_fn_func_probe(
...
public func run(args: [String]) -> RunResult {
    return try!  FfiConverterTypeRunResult.lift(try! rustCall() {
    uniffi_leclap_ffmpeg_core_fn_func_run(
        FfiConverterSequenceString.lower(args),$0
    )
})
}
...
public func version() -> String {
    ...
    uniffi_leclap_ffmpeg_core_fn_func_version($0
    )
})
}
...
private var initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_leclap_ffmpeg_core_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_leclap_ffmpeg_core_checksum_func_cancel() != 16111) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_leclap_ffmpeg_core_checksum_func_probe() != 28380) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_leclap_ffmpeg_core_checksum_func_run() != 55263) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_leclap_ffmpeg_core_checksum_func_version() != 13072) {
        return InitializationResult.apiChecksumMismatch
    }
