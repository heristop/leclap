// Render the LeClapBumper composition to the bundled bumper clip the logo-bumper partial
...
const out = path.resolve(here, '../creative-kit/src/library/videos/leclap_bumper.mp4');
