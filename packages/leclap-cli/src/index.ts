...
async function showVersion(): Promise<void> {
  // Resolve this package's own package.json relative to this module (dist/index.js in the published
  // layout), not the consumer's cwd.
  try {
    ...
    console.log(`${pc.cyan('🎬')} ${pc.bold('LeClap CLI')} v${packageData.version}`);
    ...
    console.log(`${pc.cyan('🎬')} ${pc.bold('LeClap CLI')}`);
  }
}
